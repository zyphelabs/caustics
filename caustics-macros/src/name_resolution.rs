...
impl EntityNameContext {
    ...
    /// Create a new EntityNameContext from extracted metadata
    /// This is the most robust way since it uses the actual extracted information
    pub fn from_metadata(entity_name: &str, table_name: &str) -> Self {
